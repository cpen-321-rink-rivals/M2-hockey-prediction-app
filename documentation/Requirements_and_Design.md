...
3. **[View active challenges]**: All users can view a list of challenges they are hosting or participating in.
4. **[View challenge rankings]**: All users can view challenge rankings as bingo tickets update automatically during the game.
5. **[View results]**: All users can view the final scores of a challenge after the game.
